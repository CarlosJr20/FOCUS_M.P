...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_data' + iSeqRow).bind('change', function() { sc_form_atividade_mp_carlos_data_onchange(this, iSeqRow) });
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_data" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_atividade_mp_carlos_validate_data(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
