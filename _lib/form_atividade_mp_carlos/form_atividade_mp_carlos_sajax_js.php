...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_atividade_mp_carlos_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_atividade_mp_carlos_submit_form(var_selecao_projetos, var_tag, var_selecao_atividade, var_hora_inicio, var_hora_final, var_descricao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_atividade_mp_carlos_submit_form_cb);
