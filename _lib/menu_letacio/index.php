...
echo $this->sc_temp_usr_name; echo $this->sc_temp_logged_user; ?>  
               ...
               <li class="special_link" >
                  <a href="../cards_menu/cards_menu.php" style="padding-left: 15px;" target='CMIframe' id="carrega" <img src= '<?php echo sc_url_library("sys", "nav_bar_vertical","img/ico_home.png"); ?>' class = 'icon'  class style="width: 25px;height: 25px; ">Home</a>
